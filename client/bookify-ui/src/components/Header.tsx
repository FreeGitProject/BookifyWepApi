...
import { Search, Menu, X, User, Heart, Bell, MapPin, Phone, Mail, Globe } from 'lucide-react';
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 top-full mt-2 w-64 bg-slate-800/95 backdrop-blur-lg rounded-xl border border-white/20 shadow-2xl py-2">
                  ...
                  <div className="border-t border-white/10 pt-2">
                    <button className="w-full text-left px-4 py-2 text-gray-300 hover:text-white hover:bg-white/10 transition-all">
                      Sign Out
                    </button>
                  </div>
                </div>
        ...
        <div className="lg:hidden bg-slate-900/98 backdrop-blur-lg border-t border-white/10">
          <div className="container mx-auto px-6 py-6">
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              <button className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3 rounded-lg font-semibold hover:from-purple-600 hover:to-pink-600 transition-all duration-200 shadow-lg">
                List Your Property
              </button>
            </div>
